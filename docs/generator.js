...
charts.forEach(chart => {
  ...
  <section id="id-${chart.id}">
    ...
    <p><a href="https://app.datawrapper.de/chart/${chart.id}/visualize#refine-the-chart">In Datawrapper bearbeiten</a> | <a href="https://datawrapper.dwcdn.net/${chart.id}/">Vorschau öffnen</a></p>
  </section>
  `;
});
